...
export default function Home() {
  return (
    <div className="flex min-h-screen px-12 items-center justify-center bg-black font-sans dark:bg-black">
      <main className="flex min-h-screen w-full mt-10  flex-col items-center justify-between py-10 dark:bg-black sm:items-start">
        <div className="hero mb-10 ">
          <Image src="/intro.gif" alt="Intro GIF" width={700} height={380} className="mx-auto md:scale-150 xl:scale-200 pb-20" />
